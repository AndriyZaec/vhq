    ...
    function getURLsForUpdate(){
        ...
        for (i=0;i<=pages_results_length;i++){
            if (pages_results[i]!=undefined){
                if ((pages_results[i].score==null)||(pages_results[i].totalRequestBytes==null)||(pages_results[i].numberHosts==null)||(pages_results[i].numberStaticResources==null)||(pages_results[i].cssResponseBytes==null)||(pages_results[i].imageResponseBytes==null)||(pages_results[i].javascriptResponseBytes==null)||(pages_results[i].otherResponseBytes==null)||(pages_results[i].htmlResponseBytes==null)) {
